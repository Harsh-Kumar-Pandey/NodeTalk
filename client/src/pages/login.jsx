...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    setIsLoading(true);
    clearNotification();
    showApiLoadingWithTimeout('Authenticating your credentials...', 'Server is taking time, please keep calm');
  ...
  const handleGoogleSubmit = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      clearNotification();
      showApiLoadingWithTimeout('Authenticating with Google...', 'Server is taking time, please keep calm');
      ...
      try {
        ...
        setIsLoading(false);
        showError('Server error during Google authentication.');
